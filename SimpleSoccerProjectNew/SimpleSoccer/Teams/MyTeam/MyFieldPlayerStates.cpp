...
MyGlobalPlayerState* MyGlobalPlayerState::Instance()
{
...
void MyGlobalPlayerState::Execute(FieldPlayer* player)                                     
{
...
bool MyGlobalPlayerState::OnMessage(FieldPlayer* player, const Telegram& telegram)
{
  switch(telegram.Msg)
  {
  case Msg_ReceiveBall:
    {
      ...
      //change state 
      player->GetFSM()->ChangeState(MyReceiveBall::Instance());
  ...
  case Msg_SupportAttacker:
    {
      ...
      if (player->GetFSM()->isInState(*MySupportAttacker::Instance()))
      {
        return true;
      }
      ...
      //change the state
      player->GetFSM()->ChangeState(MySupportAttacker::Instance());
  ...
  case Msg_GoHome:
    {
      ...
      player->GetFSM()->ChangeState(MyReturnToHomeRegion::Instance());
...
MyChaseBall* MyChaseBall::Instance()
{
...
void MyChaseBall::Enter(FieldPlayer* player)
{
...
void MyChaseBall::Execute(FieldPlayer* player)                                     
{
  //if the ball is within kicking range the player changes state to KickBall.
  if (player->BallWithinKickingRange())
  {
    player->GetFSM()->ChangeState(MyKickBall::Instance());
...
void MyChaseBall::Exit(FieldPlayer* player)
{
...
MySupportAttacker* MySupportAttacker::Instance()
{
...
void MySupportAttacker::Enter(FieldPlayer* player)
{
...
void MySupportAttacker::Execute(FieldPlayer* player)                                     
{
  //if his team loses control go back home
  if (!player->Team()->InControl())
  {
    player->GetFSM()->ChangeState(MyReturnToHomeRegion::Instance()); return;
  } 
...
void MySupportAttacker::Exit(FieldPlayer* player)
{
...
MyReturnToHomeRegion* MyReturnToHomeRegion::Instance()
{
...
void MyReturnToHomeRegion::Enter(FieldPlayer* player)
{
  player->Steering()->ArriveOn();
...
void MyReturnToHomeRegion::Execute(FieldPlayer* player)
{
...
void MyReturnToHomeRegion::Exit(FieldPlayer* player)
{
  player->Steering()->ArriveOff();
}
...
void MyWait::Enter(FieldPlayer* player)
{
  #ifdef PLAYER_STATE_INFO_ON
...
void MyWait::Exit(FieldPlayer* player){}
...
MyKickBall* MyKickBall::Instance()
{
...
void MyKickBall::Enter(FieldPlayer* player)
{
...
void MyKickBall::Execute(FieldPlayer* player)
{ 
  ...
  {   
    ...
    player->GetFSM()->ChangeState(MyDribble::Instance());
  }   
}
...
void MyDribble::Enter(FieldPlayer* player)
{
  //let the team know this player is controlling
  player->Team()->SetControllingPlayer(player);
...
void MyDribble::Execute(FieldPlayer* player)
{
...
MyReceiveBall* MyReceiveBall::Instance()
{
...
void MyReceiveBall::Enter(FieldPlayer* player)
{
...
void MyReceiveBall::Execute(FieldPlayer* player)
{
...
void MyReceiveBall::Exit(FieldPlayer* player)
{
  player->Steering()->ArriveOff();
  player->Steering()->PursuitOff();
