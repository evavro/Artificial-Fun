...
MyGlobalKeeperState* MyGlobalKeeperState::Instance()
{
...
bool MyGlobalKeeperState::OnMessage(GoalKeeper* keeper, const Telegram& telegram)
{
  switch(telegram.Msg)
  {
    case Msg_GoHome:
    {
      ...
      keeper->GetFSM()->ChangeState(MyReturnHome::Instance());
    }
    ...
    case Msg_ReceiveBall:
      {
        keeper->GetFSM()->ChangeState(MyInterceptBall::Instance());
      }
...
MyTendGoal* MyTendGoal::Instance()
{
...
void MyTendGoal::Enter(GoalKeeper* keeper)
{
  //turn interpose on
...
void MyTendGoal::Execute(GoalKeeper* keeper)
{
  ...
  if (keeper->BallWithinKeeperRange())
  {
    ...
    keeper->GetFSM()->ChangeState(MyPutBallBackInPlay::Instance());
...
void MyTendGoal::Exit(GoalKeeper* keeper)
{
...
MyReturnHome* MyReturnHome::Instance()
{
...
void MyReturnHome::Enter(GoalKeeper* keeper)
{
  keeper->Steering()->ArriveOn();
}

void MyReturnHome::Execute(GoalKeeper* keeper)
{
  ...
  {
    keeper->GetFSM()->ChangeState(MyTendGoal::Instance());
  }
}

void MyReturnHome::Exit(GoalKeeper* keeper)
{
...
MyInterceptBall* MyInterceptBall::Instance()
{
...
void MyInterceptBall::Enter(GoalKeeper* keeper)
{
...
void MyInterceptBall::Execute(GoalKeeper* keeper)
{ 
...
void MyInterceptBall::Exit(GoalKeeper* keeper)
{
...
MyPutBallBackInPlay* MyPutBallBackInPlay::Instance()
{
...
void MyPutBallBackInPlay::Enter(GoalKeeper* keeper)
{
...
void MyPutBallBackInPlay::Execute(GoalKeeper* keeper)
{
