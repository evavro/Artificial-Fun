...
BEWD_GlobalPlayerState* BEWD_GlobalPlayerState::Instance()
{
...
void BEWD_GlobalPlayerState::Execute(FieldPlayer* player)                                     
{
...
BEWD_ChaseBall* BEWD_ChaseBall::Instance()
{
...
void BEWD_ChaseBall::Enter(FieldPlayer* player)
{
...
void BEWD_ChaseBall::Execute(FieldPlayer* player)                                     
{
  //if the ball is within kicking range the player changes state to KickBall.
  if (player->BallWithinKickingRange())
  {
    player->GetFSM()->ChangeState(BEWD_KickBall::Instance());
...
void BEWD_ChaseBall::Exit(FieldPlayer* player)
{
...
BEWD_SupportAttacker* BEWD_SupportAttacker::Instance()
{
...
void BEWD_SupportAttacker::Enter(FieldPlayer* player)
{
...
void BEWD_SupportAttacker::Execute(FieldPlayer* player)                                     
{
  //if his team loses control go back home
  if (!player->Team()->InControl())
  {
    player->GetFSM()->ChangeState(BEWD_ReturnToHomeRegion::Instance()); return;
  } 
...
void BEWD_SupportAttacker::Exit(FieldPlayer* player)
{
...
BEWD_ReturnToHomeRegion* BEWD_ReturnToHomeRegion::Instance()
{
...
void BEWD_ReturnToHomeRegion::Enter(FieldPlayer* player)
{
  player->Steering()->ArriveOn();
...
void BEWD_ReturnToHomeRegion::Execute(FieldPlayer* player)
{
  if (player->Pitch()->GameOn())
  {
    ...
    {
     // player->GetFSM()->ChangeState(BEWD_ChaseBall::Instance());
...
void BEWD_ReturnToHomeRegion::Exit(FieldPlayer* player)
{
  player->Steering()->ArriveOff();
}
...
void BEWD_Wait::Enter(FieldPlayer* player)
{
  #ifdef PLAYER_STATE_INFO_ON
...
void BEWD_Wait::Execute(FieldPlayer* player)
{   
...
void BEWD_Wait::Exit(FieldPlayer* player){}
...
BEWD_KickBall* BEWD_KickBall::Instance()
{
...
void BEWD_KickBall::Enter(FieldPlayer* player)
{
...
void BEWD_KickBall::Execute(FieldPlayer* player)
{ 
  ...
  {   
    ...
    player->GetFSM()->ChangeState(BEWD_Dribble::Instance());
  }   
}
...
BEWD_Dribble* BEWD_Dribble::Instance()
{
...
void BEWD_Dribble::Enter(FieldPlayer* player)
{
  //let the team know this player is controlling
  player->Team()->SetControllingPlayer(player);
...
void BEWD_Dribble::Execute(FieldPlayer* player)
{
...
BEWD_ReceiveBall* BEWD_ReceiveBall::Instance()
{
...
void BEWD_ReceiveBall::Enter(FieldPlayer* player)
{
...
void BEWD_ReceiveBall::Execute(FieldPlayer* player)
{
...
void BEWD_ReceiveBall::Exit(FieldPlayer* player)
{
  player->Steering()->ArriveOff();
  player->Steering()->PursuitOff();
...
/*
//************************************************************************     FAKEOUT DRIBBLE
BEWD_FakeOutDribble* BEWD_FakeOutDribble::Instance()
{
...
void BEWD_FakeOutDribble::Enter(FieldPlayer* player)
{
	return;
}

void BEWD_FakeOutDribble::Execute(FieldPlayer* player)
{
...
void BEWD_InterceptBall::Enter(FieldPlayer* player)
{
	return;
}

void BEWD_InterceptBall::Execute(FieldPlayer* player)
{
...
//************************************************************************     MOVE TO REGION
BEWD_MoveToRegion* BEWD_MoveToRegion::Instance()
{
...
void BEWD_MoveToRegion::Enter(FieldPlayer* player) {
	return;
}

void BEWD_MoveToRegion::Execute(FieldPlayer* player) {
