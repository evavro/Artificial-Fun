...
//---------------------------- ctor -------------------------------------------
//-----------------------------------------------------------------------------
Raven_PathPlanner::Raven_PathPlanner(AbstRaven_Bot* owner):m_pOwner(owner),
...
Raven_PathPlanner::Path Raven_PathPlanner::GetPath()
{
  ...
  m_time.QuadPart += (exitTime.QuadPart - entryTime.QuadPart);
...
//-----------------------------------------------------------------------------
int Raven_PathPlanner::CycleOnce()
{
...
{    
  ...
  typedef FindActiveTrigger<Trigger<AbstRaven_Bot> > t_con; 
