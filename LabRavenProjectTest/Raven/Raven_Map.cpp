...
{
  Trigger_OnButtonSendMsg<AbstRaven_Bot>* tr = new Trigger_OnButtonSendMsg<AbstRaven_Bot>(in);
...
#ifdef LOG_CREATIONAL_STUFF
//    debug_con << "Average edge length is " << (m_dCellSpaceNeighborhoodRange - 1) << "";
#endif
...
//-----------------------------------------------------------------------------
void Raven_Map::AddSoundTrigger(AbstRaven_Bot* pSoundSource, double range)
{
...
//  all the triggers
//-----------------------------------------------------------------------------
void Raven_Map::UpdateTriggerSystem(std::list<AbstRaven_Bot*>& bots)
{
