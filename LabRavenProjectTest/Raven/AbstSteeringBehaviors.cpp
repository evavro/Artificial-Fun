...
//
//------------------------------------------------------------------------
AbstSteering::AbstSteering(Raven_Game* world, AbstRaven_Bot* agent):
...
//  in m_SummingMethod
//------------------------------------------------------------------------
Vector2D AbstSteering::Calculate()
{ 
...
//------------------------------------------------------------------------
double AbstSteering::ForwardComponent()
{
...
//------------------------------------------------------------------------
double AbstSteering::SideComponent()
{
...
//  force to add.
//------------------------------------------------------------------------
bool AbstSteering::AccumulateForce(Vector2D &RunningTot,
                                       Vector2D ForceToAdd)
{  
...
//------------------------------------------------------------------------
Vector2D AbstSteering::CalculatePrioritized()
{       
  Vector2D force;
...
//------------------------------------------------------------------------
Vector2D AbstSteering::Seek(const Vector2D &target)
{
...
//------------------------------------------------------------------------
Vector2D AbstSteering::Arrive(const Vector2D    &target,
...
//------------------------------------------------------------------------
Vector2D AbstSteering::WallAvoidance(const vector<Wall2D*> &walls)
{
...
//------------------------------------------------------------------------
void AbstSteering::CreateFeelers()
{
...
//------------------------------------------------------------------------
Vector2D AbstSteering::Separation(const std::list<AbstRaven_Bot*>& neighbors)
{  
