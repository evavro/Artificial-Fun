...
//------------------------- ctor ----------------------------------------------
//-----------------------------------------------------------------------------
AbstWeaponSystem::AbstWeaponSystem(AbstRaven_Bot* owner,
                                       double ReactionTime,
                                       double AimAccuracy,
...
//-----------------------------------------------------------------------------
void  AbstWeaponSystem::AddWeapon(unsigned int weapon_type)
{
...
//-----------------------------------------------------------------------------
Raven_Weapon* AbstWeaponSystem::GetWeaponFromInventory(int weapon_type)
{
...
//  rads
//-----------------------------------------------------------------------------
void AbstWeaponSystem::AddNoiseToAim(Vector2D& AimingPos)const
{
...
//  behavior.
//-----------------------------------------------------------------------------
Vector2D AbstWeaponSystem::PredictFuturePositionOfTarget()const
{
...
//-----------------------------------------------------------------------------
int AbstWeaponSystem::GetAmmoRemainingForWeapon(unsigned int weapon_type)
{
...
//-----------------------------------------------------------------------------
void AbstWeaponSystem::ShootAt(Vector2D pos)const
{
...
//-------------------------- RenderCurrentWeapon ------------------------------
//-----------------------------------------------------------------------------
void AbstWeaponSystem::RenderCurrentWeapon()const
{
  GetCurrentWeapon()->Render();
}

void AbstWeaponSystem::RenderDesirabilities()const
{
