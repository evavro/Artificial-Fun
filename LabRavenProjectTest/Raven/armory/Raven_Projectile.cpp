...
AbstRaven_Bot* Raven_Projectile::GetClosestIntersectingBot(Vector2D    From,
                                                       Vector2D    To)const
{
  AbstRaven_Bot* ClosestIntersectingBot = 0;
...
std::list<AbstRaven_Bot*> Raven_Projectile::GetListOfIntersectingBots(Vector2D From,
                                                                  Vector2D To)const
{
  //this will hold any bots that are intersecting with the line segment
  std::list<AbstRaven_Bot*> hits;
