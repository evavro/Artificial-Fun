...
//-------------------------- ctor ---------------------------------------------
//-----------------------------------------------------------------------------
Rocket::Rocket(AbstRaven_Bot* shooter, Vector2D target):
...
void Rocket::TestForImpact()
{
    ...
    AbstRaven_Bot* hit = GetClosestIntersectingBot(m_vPosition - m_vVelocity, m_vPosition);
...
{
  std::list<AbstRaven_Bot*>::const_iterator curBot = m_pWorld->GetAllBots().begin();
