; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Teaja\Documents\Artificial-Fun\LabRavenProjectTest\Raven\goals\Goal_AdjustRange.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??0Goal_AdjustRange@@QAE@PAVAbstRaven_Bot@@@Z	; Goal_AdjustRange::Goal_AdjustRange
...
; File c:\users\teaja\documents\artificial-fun\labravenprojecttest\raven\goals\goal_adjustrange.cpp
rdata$r	SEGMENT
...
_this$ = -4						; size = 4
_pBot$ = 8						; size = 4
??0Goal_AdjustRange@@QAE@PAVAbstRaven_Bot@@@Z PROC	; Goal_AdjustRange::Goal_AdjustRange
; _this$ = ecx
...
; 10   : {}
	...
	pop	ebp
	ret	4
??0Goal_AdjustRange@@QAE@PAVAbstRaven_Bot@@@Z ENDP	; Goal_AdjustRange::Goal_AdjustRange
_TEXT	ENDS
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$135724[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$135724[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$135724[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T143921[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T143921[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
