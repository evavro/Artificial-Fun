; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Teaja\Documents\Artificial-Fun\LabRavenProjectTest\Raven\armory\Raven_Projectile.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z ; Raven_Projectile::GetClosestIntersectingBot
...
xdata$x	SEGMENT
__unwindtable$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z$1
	DD	00H
	DD	FLAT:__unwindfunclet$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z$2
__ehfuncinfo$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z DD 019930522H
	DD	03H
	DD	FLAT:__unwindtable$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
xdata$x	ENDS
;	COMDAT rtc$TMZ
; File c:\users\teaja\documents\artificial-fun\labravenprojecttest\raven\armory\raven_projectile.cpp
rtc$TMZ	SEGMENT
...
_From$ = 8						; size = 16
_To$ = 24						; size = 16
?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z PROC ; Raven_Projectile::GetClosestIntersectingBot
; _this$ = ecx
...
; 9    : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z
...
; 10   :   AbstRaven_Bot* ClosestIntersectingBot = 0;
...
; 14   :   std::list<AbstRaven_Bot*>::const_iterator curBot;
...
$LN6@GetClosest:
	...
	mov	BYTE PTR $T140822[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T140823[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	edx, BYTE PTR $T140822[ebp]
	test	edx, edx
	je	$LN4@GetClosest
...
; 27   :         double Dist = Vec2DDistanceSq((*curBot)->Pos(), m_vOrigin);
	...
	add	esp, 8
	fstp	QWORD PTR _Dist$132965[ebp]

; 28   : 
; 29   :         if (Dist < ClosestSoFar)

	fld	QWORD PTR _ClosestSoFar$[ebp]
	fcomp	QWORD PTR _Dist$132965[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
	jne	SHORT $LN1@GetClosest
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z$0:
	lea	ecx, DWORD PTR _curBot$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z$1:
	lea	ecx, DWORD PTR $T140821[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z$2:
	lea	ecx, DWORD PTR $T140823[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__ehhandler$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-140]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?GetClosestIntersectingBot@Raven_Projectile@@IBEPAVAbstRaven_Bot@@UVector2D@@0@Z ENDP ; Raven_Projectile::GetClosestIntersectingBot
; Function compile flags: /Odtp /RTCsu
...
; 159  :   Vector2D Point = A + ((B - A) * dotA)/(dotA + dotB);
	...
	push	edx
	lea	eax, DWORD PTR $T140854[ebp]
	push	eax
	call	??G@YA?AUVector2D@@ABU0@0@Z		; operator-
	add	esp, 12					; 0000000cH
	push	eax
	lea	ecx, DWORD PTR $T140855[ebp]
	push	ecx
	call	??D@YA?AUVector2D@@ABU0@N@Z		; operator*
	add	esp, 16					; 00000010H
	push	eax
	lea	edx, DWORD PTR $T140856[ebp]
	push	edx
...
; 188  : 			_Iterator_base12 **_Pnext = &_Myproxy->_Myfirstiter;
	...
	add	edx, 4
	mov	DWORD PTR __Pnext$99554[ebp], edx
$LN3@Orphan_me:

; 189  : 			while (*_Pnext != 0 && *_Pnext != this)

	mov	eax, DWORD PTR __Pnext$99554[ebp]
	cmp	DWORD PTR [eax], 0
	je	SHORT $LN2@Orphan_me
	mov	ecx, DWORD PTR __Pnext$99554[ebp]
	mov	edx, DWORD PTR [ecx]
...
; 190  : 				_Pnext = &(*_Pnext)->_Mynextiter;
	...
	mov	ecx, DWORD PTR [eax]
	add	ecx, 4
	mov	DWORD PTR __Pnext$99554[ebp], ecx
...
; 192  : 			if (*_Pnext == 0)
	...
	mov	edx, DWORD PTR __Pnext$99554[ebp]
	cmp	DWORD PTR [edx], 0
...
; 128  : 			_Lockit _Lock(_LOCK_DEBUG);
	...
	push	3
	lea	ecx, DWORD PTR __Lock$99533[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 132  : 		}
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN11@operator@5
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
_TEXT	SEGMENT
__Lock$99544 = -40					; size = 4
__Parent_proxy$99542 = -32				; size = 4
__Lock$99540 = -24					; size = 4
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
__Parent$ = 8						; size = 4
...
; 151  : 			_Container_proxy *_Parent_proxy = _Parent->_Myproxy;
	...
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR __Parent_proxy$99542[ebp], ecx
...
; 154  : 			if (_Myproxy != _Parent_proxy)
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	cmp	eax, DWORD PTR __Parent_proxy$99542[ebp]
	je	SHORT $LN4@Adopt
...
; 158  : 				_Mynextiter = _Parent_proxy->_Myfirstiter;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR __Parent_proxy$99542[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR [ecx+4], eax

; 159  : 				_Parent_proxy->_Myfirstiter = this;

	mov	ecx, DWORD PTR __Parent_proxy$99542[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+4], edx
...
PUBLIC	?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z ; Raven_Projectile::GetListOfIntersectingBots
xdata$x	SEGMENT
__ehfuncinfo$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z DD 019930522H
	DD	05H
	DD	FLAT:__unwindtable$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
__unwindtable$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z$4
	DD	00H
	DD	FLAT:__unwindfunclet$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z$0
	DD	01H
	DD	FLAT:__unwindfunclet$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z$1
	DD	02H
	DD	FLAT:__unwindfunclet$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z$2
	DD	02H
	DD	FLAT:__unwindfunclet$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z$3
; Function compile flags: /Odtp /RTCsu
; File c:\users\teaja\documents\artificial-fun\labravenprojecttest\raven\armory\raven_projectile.cpp
xdata$x	ENDS
_TEXT	SEGMENT
...
_From$ = 12						; size = 16
_To$ = 28						; size = 16
?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z PROC ; Raven_Projectile::GetListOfIntersectingBots
; _this$ = ecx
...
; 46   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 51   :   std::list<AbstRaven_Bot*>::const_iterator curBot;
...
$LN5@GetListOfI:
	...
	lea	ecx, DWORD PTR _curBot$[ebp]
	call	??9?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QBE_NABV01@@Z ; std::_List_const_iterator<std::_List_val<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> > >::operator!=
	mov	BYTE PTR $T140952[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	lea	ecx, DWORD PTR $T140953[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	edx, BYTE PTR $T140952[ebp]
	test	edx, edx
	je	$LN3@GetListOfI
...
; 69   :   return hits;
	...
	mov	edx, DWORD PTR $T140960[ebp]
	or	edx, 1
	mov	DWORD PTR $T140960[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR _curBot$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z$0:
	lea	ecx, DWORD PTR _hits$[ebp]
...
__unwindfunclet$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z$1:
	lea	ecx, DWORD PTR _curBot$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z$2:
	lea	ecx, DWORD PTR $T140951[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z$3:
	lea	ecx, DWORD PTR $T140953[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z$4:
	mov	eax, DWORD PTR $T140960[ebp]
	and	eax, 1
	je	$LN13@GetListOfI
	and	DWORD PTR $T140960[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE@XZ ; std::list<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> >::~list<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> >
$LN13@GetListOfI:
	ret	0
__ehhandler$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-128]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?GetListOfIntersectingBots@Raven_Projectile@@IBE?AV?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@UVector2D@@0@Z ENDP ; Raven_Projectile::GetListOfIntersectingBots
...
; 797  : 		return (const_iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@1@PBV?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@1@@Z ; std::_List_const_iterator<std::_List_val<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> > >::_List_const_iterator<std::_List_val<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> > >
	mov	eax, DWORD PTR $T141000[ebp]
	or	eax, 1
	mov	DWORD PTR $T141000[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	eax, DWORD PTR $T141068[ebp]
	or	eax, 1
	mov	DWORD PTR $T141068[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@1@PBV?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> > >::_List_iterator<std::_List_val<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> > >
	mov	ecx, DWORD PTR $T141126[ebp]
	or	ecx, 1
	mov	DWORD PTR $T141126[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
$T141135 = -84						; size = 4
$T141134 = -80						; size = 4
__Next$136092 = -72					; size = 12
__Iter$136086 = -52					; size = 12
__Next$136082 = -32					; size = 12
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
__Where$ = 8						; size = 12
__Right$ = 20						; size = 4
...
; 1442 : 				for (const_iterator _Next = _First; _Next != _Last; )
	...
	push	ecx
	lea	ecx, DWORD PTR __Next$136082[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	BYTE PTR __$EHRec$[ebp+8], 3
$LN6@Splice:
...
; 1444 : 					const_iterator _Iter = _Next++;
	...
	push	0
	lea	ecx, DWORD PTR __Iter$136086[ebp]
	push	ecx
	lea	ecx, DWORD PTR __Next$136082[ebp]
...
; 1445 : 					_Orphan_ptr(_Right, _Iter._Ptr);
	...
	mov	edx, DWORD PTR __Iter$136086[ebp+8]
	push	edx
	mov	eax, DWORD PTR __Right$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1458 : 			for (const_iterator _Next = _First; _Next != _Last; ++_Next)
	...
	push	eax
	lea	ecx, DWORD PTR __Next$136092[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
...
; 1460 : 			_Right.erase(_First, _Last);
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T141140[ebp], esp
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	call	??0?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv291[ebp], eax
	lea	eax, DWORD PTR $T141141[ebp]
	push	eax
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	mov	ecx, DWORD PTR __Right$[ebp]
...
_TEXT	SEGMENT
__Pnext$99566 = -20					; size = 4
__Lock$99565 = -12					; size = 4
_this$ = -4						; size = 4
...
; 210  : 		_Lockit _Lock(_LOCK_DEBUG);
	...
	push	3
	lea	ecx, DWORD PTR __Lock$99565[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 212  : 		for (_Iterator_base12 **_Pnext = &_Myproxy->_Myfirstiter;
	...
	mov	edx, DWORD PTR [ecx]
	add	edx, 4
	mov	DWORD PTR __Pnext$99566[ebp], edx

; 213  : 			*_Pnext != 0; *_Pnext = (*_Pnext)->_Mynextiter)

	jmp	SHORT $LN3@Orphan_all
$LN2@Orphan_all:
	mov	eax, DWORD PTR __Pnext$99566[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR __Pnext$99566[ebp]
	mov	eax, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx], eax
$LN3@Orphan_all:
	mov	ecx, DWORD PTR __Pnext$99566[ebp]
	cmp	DWORD PTR [ecx], 0
...
; 1081 : 		{	// erase [_First, _Last)
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T141260[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], 2

; 1082 : 		if (_First == begin() && _Last == end())

	lea	eax, DWORD PTR $T141251[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?begin@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@XZ ; std::list<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> >::begin
	...
	mov	ecx, DWORD PTR $T141260[ebp]
	or	ecx, 2
	mov	DWORD PTR $T141260[ebp], ecx
...
$LN8@erase:
	...
	mov	BYTE PTR $T141250[ebp], cl
	mov	DWORD PTR __$EHRec$[ebp+8], 3
	mov	edx, DWORD PTR $T141260[ebp]
	and	edx, 2
	je	SHORT $LN15@erase
	and	DWORD PTR $T141260[ebp], -3		; fffffffdH
	lea	ecx, DWORD PTR $T141252[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN15@erase:
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	...
	and	eax, 1
	je	SHORT $LN16@erase
	and	DWORD PTR $T141260[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T141251[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN16@erase:
	movzx	ecx, BYTE PTR $T141250[ebp]
	test	ecx, ecx
	je	SHORT $LN2@erase
...
__unwindfunclet$?erase@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@0@Z$4:
	...
	and	eax, 4
	je	$LN18@erase
	and	DWORD PTR $T141260[ebp], -5		; fffffffbH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN18@erase:
	ret	0
...
__unwindfunclet$??E?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T141313[ebp]
	and	eax, 1
	je	$LN5@operator@9
	and	DWORD PTR $T141313[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@9:
	ret	0
...
__unwindfunclet$?_Make_iter@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T141328[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T141328[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
; 735  : 		return (emplace(_Where, _STD forward<_Valty>(_Val)));
	...
	mov	DWORD PTR tv66[ebp], eax
	mov	ecx, DWORD PTR $T141372[ebp]
	or	ecx, 1
	mov	DWORD PTR $T141372[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$insert@PAVAbstRaven_Bot@@@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@$$QAPAVAbstRaven_Bot@@@Z$0:
	...
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$??$insert@PAVAbstRaven_Bot@@@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@$$QAPAVAbstRaven_Bot@@@Z$2:
	mov	eax, DWORD PTR $T141372[ebp]
	and	eax, 1
	je	$LN6@insert
	and	DWORD PTR $T141372[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN6@insert:
	ret	0
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T141410[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T141410[ebp], 0
...
; 742  : 		return (_Make_iter(--_Where));
	...
	mov	ecx, DWORD PTR $T141438[ebp]
	or	ecx, 1
	mov	DWORD PTR $T141438[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$emplace@PAVAbstRaven_Bot@@@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@$$QAPAVAbstRaven_Bot@@@Z$0:
	...
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$??$emplace@PAVAbstRaven_Bot@@@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@$$QAPAVAbstRaven_Bot@@@Z$3:
	mov	eax, DWORD PTR $T141438[ebp]
	and	eax, 1
	je	$LN7@emplace
	and	DWORD PTR $T141438[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN7@emplace:
	ret	0
...
; 48   : 	::new (_Vptr) _Ty1(_STD forward<_Ty2>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T141451[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T141451[ebp], 0
	je	SHORT $LN3@Construct
	mov	edx, DWORD PTR __Val$[ebp]
	push	edx
	call	??$forward@ABQAVAbstRaven_Bot@@@std@@YAABQAVAbstRaven_Bot@@ABQAV1@@Z ; std::forward<AbstRaven_Bot * const &>
	add	esp, 4
	mov	ecx, DWORD PTR $T141451[ebp]
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR $T141451[ebp]
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T141498[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T141498[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@PAVAbstRaven_Bot@@@std@@YA$$QAPAVAbstRaven_Bot@@AAPAV1@@Z ; std::forward<AbstRaven_Bot *>
	add	esp, 4
	mov	edx, DWORD PTR $T141498[ebp]
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR [edx], eax
	mov	ecx, DWORD PTR $T141498[ebp]
