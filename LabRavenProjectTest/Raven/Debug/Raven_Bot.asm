; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Teaja\Documents\Artificial-Fun\LabRavenProjectTest\Raven\Bots\RavenBot\Raven_Bot.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_colors	DD	0ffH
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG146298 DB	'Bot_GoalAppraisalUpdateFreq', 00H
_SmallestDelay DQ 03fd0000000000000r		; 0.25
_SEND_MSG_IMMEDIATELY DQ 00000000000000000r	; 0
$SG146293 DB	'Bot_WeaponSelectionFrequency', 00H
	ORG $+3
$SG146303 DB	'Bot_TargetingUpdateFreq', 00H
$SG146308 DB	'Bot_TriggerUpdateFreq', 00H
	ORG $+2
$SG146313 DB	'Bot_VisionUpdateFreq', 00H
	ORG $+3
$SG146326 DB	'Bot_AimPersistance', 00H
	ORG $+1
$SG146327 DB	'Bot_AimAccuracy', 00H
$SG146328 DB	'Bot_ReactionTime', 00H
	ORG $+3
$SG146333 DB	'Bot_MemorySpan', 00H
	ORG $+1
$SG146377 DB	'Buckland', 00H
CONST	ENDS
...
PUBLIC	?DoUpdate@Raven_Bot@@UAEXXZ			; Raven_Bot::DoUpdate
PUBLIC	?SelectBodyPen@Raven_Bot@@UAEXXZ		; Raven_Bot::SelectBodyPen
PUBLIC	?SelectHeadPen@Raven_Bot@@UAEXXZ		; Raven_Bot::SelectHeadPen
PUBLIC	?GetName@Raven_Bot@@UBE?BV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ ; Raven_Bot::GetName
...
EXTRN	??0Raven_TargetingSystem@@QAE@PAVAbstRaven_Bot@@@Z:PROC ; Raven_TargetingSystem::Raven_TargetingSystem
...
EXTRN	??0Raven_BotSteering@@QAE@PAVRaven_Game@@PAVAbstRaven_Bot@@@Z:PROC ; Raven_BotSteering::Raven_BotSteering
...
EXTRN	?Instance@Raven_BotScriptor@@SAPAV1@XZ:PROC	; Raven_BotScriptor::Instance
...
; File c:\users\teaja\documents\artificial-fun\labravenprojecttest\raven\bots\ravenbot\raven_bot.cpp
rdata$r	SEGMENT
...
??_7Raven_Bot@@6B@ DD FLAT:??_R4Raven_Bot@@6B@		; Raven_Bot::`vftable'
	...
	DD	FLAT:?DoUpdate@Raven_Bot@@UAEXXZ
	...
	DD	FLAT:?SelectBodyPen@Raven_Bot@@UAEXXZ
	DD	FLAT:?SelectHeadPen@Raven_Bot@@UAEXXZ
	DD	FLAT:?GetName@Raven_Bot@@UBE?BV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
CONST	ENDS
xdata$x	SEGMENT
...
; 28   : 	m_pScript = Raven_BotScriptor::Instance();

	call	?Instance@Raven_BotScriptor@@SAPAV1@XZ	; Raven_BotScriptor::Instance
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+296], eax

; 29   : 	SetEntityType(type_bot);
...
; 30   : 
; 31   :   SetUpVertexBuffer();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetUpVertexBuffer@AbstRaven_Bot@@IAEXXZ ; AbstRaven_Bot::SetUpVertexBuffer

; 32   :   
; 33   :   //a bot starts off facing in the direction it is heading
; 34   :   m_vFacing = m_vHeading;
...
; 35   : 
; 36   :   //create the navigation module
; 37   :   m_pPathPlanner = new Raven_PathPlanner(this);

	push	40					; 00000028H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T158099[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	cmp	DWORD PTR $T158099[ebp], 0
	je	SHORT $LN3@Raven_Bot
	mov	ecx, DWORD PTR _this$[ebp]
	push	ecx
	mov	ecx, DWORD PTR $T158099[ebp]
...
$LN4@Raven_Bot:
	...
	mov	DWORD PTR $T158098[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR $T158098[ebp]
	mov	DWORD PTR [eax+172], ecx

; 38   : 
; 39   :   //create the steering behavior class
; 40   :   m_pSteering = new Raven_BotSteering(world, this);

	push	192					; 000000c0H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T158103[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	cmp	DWORD PTR $T158103[ebp], 0
	je	SHORT $LN5@Raven_Bot
	mov	edx, DWORD PTR _this$[ebp]
	push	edx
	mov	eax, DWORD PTR _world$[ebp]
	push	eax
	mov	ecx, DWORD PTR $T158103[ebp]
	call	??0Raven_BotSteering@@QAE@PAVRaven_Game@@PAVAbstRaven_Bot@@@Z ; Raven_BotSteering::Raven_BotSteering
...
$LN6@Raven_Bot:
	...
	mov	DWORD PTR $T158102[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR $T158102[ebp]
	mov	DWORD PTR [edx+168], eax

; 41   : 
; 42   :   //create the regulators
; 43   :   m_pWeaponSelectionRegulator = new Regulator(m_pScript->GetDouble("Bot_WeaponSelectionFrequency"));
...
$LN8@Raven_Bot:
	...
	mov	DWORD PTR $T158106[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR $T158106[ebp]
	mov	DWORD PTR [eax+184], ecx

; 44   :   m_pGoalArbitrationRegulator =  new Regulator(m_pScript->GetDouble("Bot_GoalAppraisalUpdateFreq"));

	push	16					; 00000010H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T158111[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 4
	cmp	DWORD PTR $T158111[ebp], 0
...
$LN10@Raven_Bot:
	...
	mov	DWORD PTR $T158110[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR $T158110[ebp]
	mov	DWORD PTR [ecx+188], edx

; 45   :   m_pTargetSelectionRegulator = new Regulator(m_pScript->GetDouble("Bot_TargetingUpdateFreq"));

	push	16					; 00000010H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T158115[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 5
	cmp	DWORD PTR $T158115[ebp], 0
...
$LN12@Raven_Bot:
	...
	mov	DWORD PTR $T158114[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR $T158114[ebp]
	mov	DWORD PTR [edx+192], eax

; 46   :   m_pTriggerTestRegulator = new Regulator(script->GetDouble("Bot_TriggerUpdateFreq"));

	push	16					; 00000010H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T158119[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 6
	cmp	DWORD PTR $T158119[ebp], 0
...
$LN14@Raven_Bot:
	...
	mov	DWORD PTR $T158118[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR $T158118[ebp]
	mov	DWORD PTR [edx+196], eax

; 47   :   m_pVisionUpdateRegulator = new Regulator(m_pScript->GetDouble("Bot_VisionUpdateFreq"));

	push	16					; 00000010H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T158123[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 7
	cmp	DWORD PTR $T158123[ebp], 0
...
$LN16@Raven_Bot:
	...
	mov	DWORD PTR $T158122[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR $T158122[ebp]
	mov	DWORD PTR [eax+200], ecx

; 48   : 
; 49   :   //create the goal queue
; 50   :   m_pBrain = new Goal_Think(this);

	push	52					; 00000034H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T158127[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 8
	cmp	DWORD PTR $T158127[ebp], 0
	je	SHORT $LN17@Raven_Bot
	mov	edx, DWORD PTR _this$[ebp]
	push	edx
	mov	ecx, DWORD PTR $T158127[ebp]
...
$LN18@Raven_Bot:
	...
	mov	DWORD PTR $T158126[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR $T158126[ebp]
	mov	DWORD PTR [ecx+160], edx

; 51   : 
; 52   :   //create the targeting system
; 53   :   m_pTargSys = new Raven_TargetingSystem(this);

	push	12					; 0000000cH
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T158131[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 9
	cmp	DWORD PTR $T158131[ebp], 0
	je	SHORT $LN19@Raven_Bot
	mov	eax, DWORD PTR _this$[ebp]
	push	eax
	mov	ecx, DWORD PTR $T158131[ebp]
	call	??0Raven_TargetingSystem@@QAE@PAVAbstRaven_Bot@@@Z ; Raven_TargetingSystem::Raven_TargetingSystem
...
$LN20@Raven_Bot:
	...
	mov	DWORD PTR $T158130[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR $T158130[ebp]
	mov	DWORD PTR [edx+176], eax

; 54   : 
; 55   :   m_pWeaponSys = new Raven_WeaponSystem(this,
; 56   :                                         script->GetDouble("Bot_ReactionTime"),
; 57   :                                         script->GetDouble("Bot_AimAccuracy"),
; 58   :                                         m_pScript->GetDouble("Bot_AimPersistance"));

	push	64					; 00000040H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T158135[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 10		; 0000000aH
	cmp	DWORD PTR $T158135[ebp], 0
...
$LN22@Raven_Bot:
	...
	mov	DWORD PTR $T158134[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR $T158134[ebp]
	mov	DWORD PTR [ecx+180], edx

; 59   : 
; 60   :   m_pSensoryMem = new Raven_SensoryMemory(this, m_pScript->GetDouble("Bot_MemorySpan"));

	push	32					; 00000020H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T158139[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 11		; 0000000bH
	cmp	DWORD PTR $T158139[ebp], 0
	je	SHORT $LN23@Raven_Bot
	push	OFFSET $SG146333
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+296]
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
...
$LN24@Raven_Bot:
	...
	mov	DWORD PTR $T158138[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR $T158138[ebp]
...
; 67   :   #ifdef SHOW_NAVINFO
; 68   : 	debug_con << "deleting raven bot (id = " << ID() << ")" << "";
; 69   :   #endif 
; 70   :   
; 71   :   delete m_pBrain;
	...
	mov	DWORD PTR $T158199[ebp], edx
	mov	eax, DWORD PTR $T158199[ebp]
	mov	DWORD PTR $T158198[ebp], eax
	cmp	DWORD PTR $T158198[ebp], 0
	je	SHORT $LN3@Raven_Bot@2
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR $T158198[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR $T158198[ebp]
	...
	jmp	SHORT $LN4@Raven_Bot@2
$LN3@Raven_Bot@2:
	mov	DWORD PTR tv89[ebp], 0
$LN4@Raven_Bot@2:

; 72   :   delete m_pPathPlanner;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+172]
	mov	DWORD PTR $T158203[ebp], edx
	mov	eax, DWORD PTR $T158203[ebp]
	mov	DWORD PTR $T158202[ebp], eax
	cmp	DWORD PTR $T158202[ebp], 0
	je	SHORT $LN5@Raven_Bot@2
	push	1
	mov	ecx, DWORD PTR $T158202[ebp]
	call	??_GRaven_PathPlanner@@QAEPAXI@Z
	mov	DWORD PTR tv131[ebp], eax
	jmp	SHORT $LN6@Raven_Bot@2
$LN5@Raven_Bot@2:
	mov	DWORD PTR tv131[ebp], 0
$LN6@Raven_Bot@2:

; 73   :   delete m_pSteering;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+168]
	mov	DWORD PTR $T158207[ebp], edx
	mov	eax, DWORD PTR $T158207[ebp]
	mov	DWORD PTR $T158206[ebp], eax
	cmp	DWORD PTR $T158206[ebp], 0
	je	SHORT $LN7@Raven_Bot@2
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR $T158206[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR $T158206[ebp]
	...
	jmp	SHORT $LN8@Raven_Bot@2
$LN7@Raven_Bot@2:
	mov	DWORD PTR tv143[ebp], 0
$LN8@Raven_Bot@2:

; 74   :   delete m_pWeaponSelectionRegulator;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+184]
	mov	DWORD PTR $T158210[ebp], edx
	mov	eax, DWORD PTR $T158210[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4

; 75   :   delete m_pTargSys;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+176]
	mov	DWORD PTR $T158211[ebp], edx
	mov	eax, DWORD PTR $T158211[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4

; 76   :   delete m_pGoalArbitrationRegulator;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+188]
	mov	DWORD PTR $T158212[ebp], edx
	mov	eax, DWORD PTR $T158212[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4

; 77   :   delete m_pTargetSelectionRegulator;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+192]
	mov	DWORD PTR $T158213[ebp], edx
	mov	eax, DWORD PTR $T158213[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4

; 78   :   delete m_pTriggerTestRegulator;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+196]
	mov	DWORD PTR $T158214[ebp], edx
	mov	eax, DWORD PTR $T158214[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4

; 79   :   delete m_pVisionUpdateRegulator;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+200]
	mov	DWORD PTR $T158215[ebp], edx
	mov	eax, DWORD PTR $T158215[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4

; 80   :   delete m_pWeaponSys;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+180]
	mov	DWORD PTR $T158217[ebp], edx
	mov	eax, DWORD PTR $T158217[ebp]
	mov	DWORD PTR $T158216[ebp], eax
	cmp	DWORD PTR $T158216[ebp], 0
	je	SHORT $LN9@Raven_Bot@2
	push	1
	mov	ecx, DWORD PTR $T158216[ebp]
	call	??_GAbstWeaponSystem@@QAEPAXI@Z
	mov	DWORD PTR tv189[ebp], eax
	jmp	SHORT $LN10@Raven_Bot@2
$LN9@Raven_Bot@2:
	mov	DWORD PTR tv189[ebp], 0
$LN10@Raven_Bot@2:

; 81   :   delete m_pSensoryMem;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+164]
	mov	DWORD PTR $T158221[ebp], edx
	mov	eax, DWORD PTR $T158221[ebp]
	mov	DWORD PTR $T158220[ebp], eax
	cmp	DWORD PTR $T158220[ebp], 0
	je	SHORT $LN11@Raven_Bot@2
	push	1
	mov	ecx, DWORD PTR $T158220[ebp]
	call	??_GRaven_SensoryMemory@@QAEPAXI@Z
	mov	DWORD PTR tv199[ebp], eax
	jmp	SHORT $LN1@Raven_Bot@2
$LN11@Raven_Bot@2:
...
?GetName@Raven_Bot@@UBE?BV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ PROC ; Raven_Bot::GetName
; _this$ = ecx

; 84   : std::string const Raven_Bot::GetName () const { return "Buckland"; }
	...
	mov	DWORD PTR [ebp-4], -858993460		; ccccccccH
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T158243[ebp], 0
	push	OFFSET $SG146377
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T158243[ebp]
	or	eax, 1
	mov	DWORD PTR $T158243[ebp], eax
	...
	pop	ebp
	ret	4
?GetName@Raven_Bot@@UBE?BV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ ENDP ; Raven_Bot::GetName
_TEXT	ENDS
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?DoUpdate@Raven_Bot@@UAEXXZ PROC			; Raven_Bot::DoUpdate
; _this$ = ecx
...
; 90   :   //process the currently active goal. Note this is required even if the bot
; 91   :   //is under user control. This is because a goal is created whenever a user 
; 92   :   //clicks on an area of the map that necessitates a path planning request.
; 93   :   m_pBrain->Process();
...
; 94   :   
; 95   :   //Calculate the steering force and update the bot's velocity and position
; 96   :   UpdateMovement();
...
; 97   : 
; 98   :   //if the bot is under AI control but not scripted
; 99   :   if (!isPossessed())
...
; 100  :   {           
; 101  :     //examine all the opponents in the bots sensory memory and select one
; 102  :     //to be the current target
; 103  :     if (m_pTargetSelectionRegulator->isReady())
...
; 106  :     }
; 107  : 
; 108  :     //appraise and arbitrate between all possible high level goals
; 109  :     if (m_pGoalArbitrationRegulator->isReady())
...
; 112  :     }
; 113  : 
; 114  :     //update the sensory memory with any visual stimulus
; 115  :     if (m_pVisionUpdateRegulator->isReady())
...
; 116  :     {
; 117  :       m_pSensoryMem->UpdateVision();
...
; 118  :     }
; 119  :   
; 120  :     //select the appropriate weapon to use from the weapons currently in
; 121  :     //the inventory
; 122  :     if (m_pWeaponSelectionRegulator->isReady())
...
; 125  :     }
; 126  : 
; 127  :     //this method aims the bot's current weapon at the current target
; 128  :     //and takes a shot if a shot is possible
; 129  :     m_pWeaponSys->TakeAimAndShoot();
...
; 131  : }
	...
	pop	ebp
	ret	0
?DoUpdate@Raven_Bot@@UAEXXZ ENDP			; Raven_Bot::DoUpdate
; Function compile flags: /Odtp /RTCsu
; File c:\users\teaja\documents\artificial-fun\labravenprojecttest\raven\abstraven_bot.h
_TEXT	ENDS
...
; 139  :   //first see if the current goal accepts the message
; 140  :   if (GetBrain()->HandleMessage(msg)) return true;
...
; 141  :  
; 142  :   //handle any messages not handles by the goals
; 143  :   switch(msg.Msg)
...
; 144  :   {
; 145  :   case Msg_TakeThatMF:
; 146  : 
; 147  :     //just return if already dead or spawning
; 148  :     if (isDead() || isSpawning()) return true;
...
; 149  : 
; 150  :     //the extra info field of the telegram carries the amount of damage
; 151  :     ReduceHealth(DereferenceToType<int>(msg.ExtraInfo));
...
; 152  : 
; 153  :     //if this bot is now dead let the shooter know
; 154  :     if (isDead())
...
; 155  :     {
; 156  :       Dispatcher->DispatchMsg(SEND_MSG_IMMEDIATELY,
; 157  :                               ID(),
; 158  :                               msg.Sender,
; 159  :                               Msg_YouGotMeYouSOB,
; 160  :                               NO_ADDITIONAL_INFO);
...
; 168  :     
; 169  :     //the bot this bot has just killed should be removed as the target
; 170  :     m_pTargSys->ClearTarget();
...
; 173  : 
; 174  :   case Msg_GunshotSound:
; 175  : 
; 176  :     //add the source of this sound to the bot's percepts
; 177  :     GetSensoryMem()->UpdateWithSoundSource((Raven_Bot*)msg.ExtraInfo);
...
; 180  : 
; 181  :   case Msg_UserHasRemovedBot:
; 182  :     {
; 183  : 
; 184  :       Raven_Bot* pRemovedBot = (Raven_Bot*)msg.ExtraInfo;

	mov	ecx, DWORD PTR _msg$[ebp]
	mov	edx, DWORD PTR [ecx+24]
	mov	DWORD PTR _pRemovedBot$146408[ebp], edx

; 185  : 
; 186  :       GetSensoryMem()->RemoveBotFromMemory(pRemovedBot);

	mov	eax, DWORD PTR _pRemovedBot$146408[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetSensoryMem@AbstRaven_Bot@@QBEQAVRaven_SensoryMemory@@XZ ; AbstRaven_Bot::GetSensoryMem
	mov	ecx, eax
...
; 187  : 
; 188  :       //if the removed bot is the target, make sure the target is cleared
; 189  :       if (pRemovedBot == GetTargetSys()->GetTarget())
	...
	cmp	DWORD PTR _pRemovedBot$146408[ebp], eax
	jne	SHORT $LN2@HandleMess

; 190  :       {
; 191  :         GetTargetSys()->ClearTarget();
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?SelectBodyPen@Raven_Bot@@UAEXXZ PROC			; Raven_Bot::SelectBodyPen
; _this$ = ecx
...
; 205  : }
	...
	pop	ebp
	ret	0
?SelectBodyPen@Raven_Bot@@UAEXXZ ENDP			; Raven_Bot::SelectBodyPen
_TEXT	ENDS
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?SelectHeadPen@Raven_Bot@@UAEXXZ PROC			; Raven_Bot::SelectHeadPen
; _this$ = ecx
...
; 209  :  }
	...
	pop	ebp
	ret	0
?SelectHeadPen@Raven_Bot@@UAEXXZ ENDP			; Raven_Bot::SelectHeadPen
; Function compile flags: /Odtp /RTCsu
; File c:\users\teaja\documents\artificial-fun\labravenprojecttest\common\misc\cgdi.h
_TEXT	ENDS
...
; 1992 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$148501[ebp], eax
...
; 1994 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$148501[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1995 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$148501[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1866 : 		erase(begin(), end());
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T158350[ebp], esp
	mov	eax, DWORD PTR tv151[ebp]
	push	eax
	call	??0?$_Tree_const_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv154[ebp], eax
	lea	ecx, DWORD PTR $T158352[ebp]
	push	ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1953 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T158440[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T158440[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 807  : 		return (iterator(_Lmost(), this));
	...
	mov	edx, DWORD PTR $T158458[ebp]
	or	edx, 1
	mov	DWORD PTR $T158458[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 817  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Tree_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@PAU_Node@?$_Tree_nod@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@1@PBV?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@1@@Z ; std::_Tree_iterator<std::_Tree_val<std::_Tmap_traits<AbstRaven_Bot *,MemoryRecord,std::less<AbstRaven_Bot *>,std::allocator<std::pair<AbstRaven_Bot * const,MemoryRecord> >,0> > >::_Tree_iterator<std::_Tree_val<std::_Tmap_traits<AbstRaven_Bot *,MemoryRecord,std::less<AbstRaven_Bot *>,std::allocator<std::pair<AbstRaven_Bot * const,MemoryRecord> >,0> > >
	mov	eax, DWORD PTR $T158463[ebp]
	or	eax, 1
	mov	DWORD PTR $T158463[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1379 : 		{	// erase [_First, _Last)
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T158476[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], 2

; 1380 : 		if (_First == begin() && _Last == end())

	lea	eax, DWORD PTR $T158468[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?begin@?$_Tree@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@QAE?AV?$_Tree_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@2@XZ ; std::_Tree<std::_Tmap_traits<AbstRaven_Bot *,MemoryRecord,std::less<AbstRaven_Bot *>,std::allocator<std::pair<AbstRaven_Bot * const,MemoryRecord> >,0> >::begin
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	mov	edx, DWORD PTR $T158476[ebp]
	or	edx, 1
	mov	DWORD PTR $T158476[ebp], edx
	...
	mov	ecx, DWORD PTR $T158476[ebp]
	or	ecx, 2
	mov	DWORD PTR $T158476[ebp], ecx
...
$LN8@erase:
	...
	mov	BYTE PTR $T158467[ebp], cl
	mov	DWORD PTR __$EHRec$[ebp+8], 3
	mov	edx, DWORD PTR $T158476[ebp]
	and	edx, 2
	je	SHORT $LN15@erase
	and	DWORD PTR $T158476[ebp], -3		; fffffffdH
	lea	ecx, DWORD PTR $T158469[ebp]
	call	??1?$_Tree_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@XZ
$LN15@erase:
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR $T158476[ebp]
	and	eax, 1
	je	SHORT $LN16@erase
	and	DWORD PTR $T158476[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T158468[ebp]
	call	??1?$_Tree_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@XZ
$LN16@erase:
	movzx	ecx, BYTE PTR $T158467[ebp]
	test	ecx, ecx
	je	SHORT $LN2@erase
...
__unwindfunclet$?erase@?$_Tree@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@QAE?AV?$_Tree_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@2@V?$_Tree_const_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@2@0@Z$4:
	...
	and	eax, 4
	je	$LN18@erase
	and	DWORD PTR $T158476[ebp], -5		; fffffffbH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Tree_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@XZ
$LN18@erase:
	ret	0
...
; 1117 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$148480[ebp], eax

; 1118 : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$148480[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase@2:
...
; 1375 : 		return (iterator(_Where._Ptr, this));	// return successor iterator
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Tree_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@PAU_Node@?$_Tree_nod@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@1@PBV?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@1@@Z ; std::_Tree_iterator<std::_Tree_val<std::_Tmap_traits<AbstRaven_Bot *,MemoryRecord,std::less<AbstRaven_Bot *>,std::allocator<std::pair<AbstRaven_Bot * const,MemoryRecord> >,0> > >::_Tree_iterator<std::_Tree_val<std::_Tmap_traits<AbstRaven_Bot *,MemoryRecord,std::less<AbstRaven_Bot *>,std::allocator<std::pair<AbstRaven_Bot * const,MemoryRecord> >,0> > >
	mov	ecx, DWORD PTR $T158563[ebp]
	or	ecx, 1
	mov	DWORD PTR $T158563[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_Tree_const_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?erase@?$_Tree@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@QAE?AV?$_Tree_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@2@V?$_Tree_const_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@2@@Z$0:
	...
	jmp	??1?$_Tree_const_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$?erase@?$_Tree@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@QAE?AV?$_Tree_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@2@V?$_Tree_const_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T158563[ebp]
	and	eax, 1
	je	$LN50@erase@3
	and	DWORD PTR $T158563[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Tree_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@XZ
$LN50@erase@3:
	ret	0
...
; 273  : 		return (_Tmp);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_Tree_const_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T158586[ebp]
	or	edx, 1
	mov	DWORD PTR $T158586[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_Tree_const_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??E?$_Tree_const_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T158586[ebp]
	and	eax, 1
	je	$LN5@operator@2
	and	DWORD PTR $T158586[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_Tree_const_iterator@V?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@@std@@QAE@XZ
$LN5@operator@2:
	ret	0
...
; 1611 : 		for (_Nodeptr _Pnode = _Rootnode;
	...
	mov	DWORD PTR __Pnode$151586[ebp], eax

; 1612 : 			!this->_Isnil(_Pnode); _Rootnode = _Pnode)

	jmp	SHORT $LN3@Erase
$LN2@Erase:
	mov	ecx, DWORD PTR __Pnode$151586[ebp]
	mov	DWORD PTR __Rootnode$[ebp], ecx
$LN3@Erase:
	mov	edx, DWORD PTR __Pnode$151586[ebp]
	push	edx
	call	?_Isnil@?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@SAAADPAU_Node@?$_Tree_nod@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@2@@Z ; std::_Tree_val<std::_Tmap_traits<AbstRaven_Bot *,MemoryRecord,std::less<AbstRaven_Bot *>,std::allocator<std::pair<AbstRaven_Bot * const,MemoryRecord> >,0> >::_Isnil
	add	esp, 4
	movsx	eax, BYTE PTR [eax]
...
; 1615 : 			_Pnode = this->_Left(_Pnode);
	...
	mov	eax, DWORD PTR __Pnode$151586[ebp]
	push	eax
	call	?_Left@?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@SAAAPAU_Node@?$_Tree_nod@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@2@PAU342@@Z ; std::_Tree_val<std::_Tmap_traits<AbstRaven_Bot *,MemoryRecord,std::less<AbstRaven_Bot *>,std::allocator<std::pair<AbstRaven_Bot * const,MemoryRecord> >,0> >::_Left
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR __Pnode$151586[ebp], ecx
...
; 68   : 				&& _Ptr == _Mytree::_Right(_Pnode))
	...
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR __Pnode$151920[ebp], ecx
	mov	edx, DWORD PTR __Pnode$151920[ebp]
	push	edx
	call	?_Isnil@?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@SAAADPAU_Node@?$_Tree_nod@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@2@@Z ; std::_Tree_val<std::_Tmap_traits<AbstRaven_Bot *,MemoryRecord,std::less<AbstRaven_Bot *>,std::allocator<std::pair<AbstRaven_Bot * const,MemoryRecord> >,0> >::_Isnil
	add	esp, 4
	movsx	eax, BYTE PTR [eax]
	...
	mov	ecx, DWORD PTR __Pnode$151920[ebp]
	push	ecx
	call	?_Right@?$_Tree_val@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@std@@SAAAPAU_Node@?$_Tree_nod@V?$_Tmap_traits@PAVAbstRaven_Bot@@VMemoryRecord@@U?$less@PAVAbstRaven_Bot@@@std@@V?$allocator@U?$pair@QAVAbstRaven_Bot@@VMemoryRecord@@@std@@@4@$0A@@std@@@2@PAU342@@Z ; std::_Tree_val<std::_Tmap_traits<AbstRaven_Bot *,MemoryRecord,std::less<AbstRaven_Bot *>,std::allocator<std::pair<AbstRaven_Bot * const,MemoryRecord> >,0> >::_Right
	add	esp, 4
	mov	edx, DWORD PTR _this$[ebp]
...
; 69   : 				_Ptr = _Pnode;	// ==> parent while right subtree
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR __Pnode$151920[ebp]
...
; 79   :     std::string err("<PopLuaNumber> Cannot retrieve: ");
	...
	lea	ecx, DWORD PTR _err$152685[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 81   :     throw std::runtime_error(err + name);
	...
	mov	ecx, DWORD PTR _name$[ebp]
	push	ecx
	lea	edx, DWORD PTR _err$152685[ebp]
	push	edx
	...
	lea	eax, DWORD PTR $T158683[ebp]
	push	eax
	call	__CxxThrowException@8
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T152686[ebp]
...
; 165  : 		{	// construct from message string
	...
	mov	DWORD PTR $T158697[ebp], eax
	lea	eax, DWORD PTR $T158697[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 69   : 	return (_Ans);
	...
	mov	ecx, DWORD PTR $T158723[ebp]
	or	ecx, 1
	mov	DWORD PTR $T158723[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Ans$[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$?HDU?$char_traits@D@std@@V?$allocator@D@1@@std@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@0@ABV10@PBD@Z$1:
	mov	eax, DWORD PTR $T158723[ebp]
	and	eax, 1
	je	$LN5@operator@6
	and	DWORD PTR $T158723[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
$LN5@operator@6:
	ret	0
...
; 1542 : 			size_type _Size = this->_Mysize;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+20]
	mov	DWORD PTR __Size$154219[ebp], edx
...
; 1544 : 				_Eos(_Size);
	...
	mov	edx, DWORD PTR __Size$154219[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN3@reserve:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T158825[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T158825[ebp], 0
	...
	mov	ecx, DWORD PTR $T158825[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T158825[ebp]
