; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Teaja\Documents\Artificial-Fun\LabRavenProjectTest\Raven\Bots\RBBot\RB_BotMaker.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
PUBLIC	??_7RB_BotMaker@@6B@				; RB_BotMaker::`vftable'
PUBLIC	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
PUBLIC	??0RB_BotMaker@@AAE@XZ				; RB_BotMaker::RB_BotMaker
PUBLIC	??_R4RB_BotMaker@@6B@				; RB_BotMaker::`RTTI Complete Object Locator'
PUBLIC	??_R0?AVRB_BotMaker@@@8				; RB_BotMaker `RTTI Type Descriptor'
PUBLIC	??_R3RB_BotMaker@@8				; RB_BotMaker::`RTTI Class Hierarchy Descriptor'
PUBLIC	??_R2RB_BotMaker@@8				; RB_BotMaker::`RTTI Base Class Array'
PUBLIC	??_R1A@?0A@EA@RB_BotMaker@@8			; RB_BotMaker::`RTTI Base Class Descriptor at (0,-1,0,64)'
...
PUBLIC	?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z ; RB_BotMaker::makeBot
...
; File c:\users\teaja\documents\artificial-fun\labravenprojecttest\raven\bots\rbbot\rb_botmaker.cpp
rdata$r	SEGMENT
...
rdata$r	ENDS
;	COMDAT ??_R1A@?0A@EA@RB_BotMaker@@8
rdata$r	SEGMENT
??_R1A@?0A@EA@RB_BotMaker@@8 DD FLAT:??_R0?AVRB_BotMaker@@@8 ; RB_BotMaker::`RTTI Base Class Descriptor at (0,-1,0,64)'
	DD	01H
	DD	00H
	DD	0ffffffffH
	DD	00H
	DD	040H
	DD	FLAT:??_R3RB_BotMaker@@8
rdata$r	ENDS
;	COMDAT ??_R2RB_BotMaker@@8
rdata$r	SEGMENT
??_R2RB_BotMaker@@8 DD FLAT:??_R1A@?0A@EA@RB_BotMaker@@8 ; RB_BotMaker::`RTTI Base Class Array'
	DD	FLAT:??_R1A@?0A@EA@BotMaker@@8
rdata$r	ENDS
;	COMDAT ??_R3RB_BotMaker@@8
rdata$r	SEGMENT
??_R3RB_BotMaker@@8 DD 00H				; RB_BotMaker::`RTTI Class Hierarchy Descriptor'
	DD	00H
	DD	02H
	DD	FLAT:??_R2RB_BotMaker@@8
rdata$r	ENDS
;	COMDAT ??_R0?AVRB_BotMaker@@@8
_DATA	SEGMENT
??_R0?AVRB_BotMaker@@@8 DD FLAT:??_7type_info@@6B@	; RB_BotMaker `RTTI Type Descriptor'
	DD	00H
	DB	'.?AVRB_BotMaker@@', 00H
_DATA	ENDS
;	COMDAT ??_R4RB_BotMaker@@6B@
rdata$r	SEGMENT
??_R4RB_BotMaker@@6B@ DD 00H				; RB_BotMaker::`RTTI Complete Object Locator'
	DD	00H
	DD	00H
	DD	FLAT:??_R0?AVRB_BotMaker@@@8
	DD	FLAT:??_R3RB_BotMaker@@8
rdata$r	ENDS
;	COMDAT ??_7RB_BotMaker@@6B@
CONST	SEGMENT
??_7RB_BotMaker@@6B@ DD FLAT:??_R4RB_BotMaker@@6B@	; RB_BotMaker::`vftable'
	DD	FLAT:?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z
CONST	ENDS
;	COMDAT rtc$TMZ
rtc$TMZ	SEGMENT
...
$T142444 = -8						; size = 4
_this$ = -4						; size = 4
??0RB_BotMaker@@AAE@XZ PROC				; RB_BotMaker::RB_BotMaker
; _this$ = ecx

; 6    : RB_BotMaker::RB_BotMaker() : BotMaker("RB_Bot") {}
	...
	mov	DWORD PTR [eax], OFFSET ??_7RB_BotMaker@@6B@
	mov	eax, DWORD PTR _this$[ebp]
	...
	pop	ebp
	ret	0
??0RB_BotMaker@@AAE@XZ ENDP				; RB_BotMaker::RB_BotMaker
_TEXT	ENDS
EXTRN	??3@YAXPAX@Z:PROC				; operator delete
EXTRN	??0RB_Bot@@QAE@PAVRaven_Game@@UVector2D@@@Z:PROC ; RB_Bot::RB_Bot
EXTRN	??2@YAPAXI@Z:PROC				; operator new
EXTRN	___security_cookie:DWORD
EXTRN	___CxxFrameHandler3:PROC
EXTRN	@__security_check_cookie@4:PROC
xdata$x	SEGMENT
__unwindtable$?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z$0
__ehfuncinfo$?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_world$ = 8						; size = 4
_pos$ = 12						; size = 16
?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z PROC ; RB_BotMaker::makeBot
; _this$ = ecx
...
; 9    :    { 
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z
...
; 10   :       return new RB_Bot(world, pos); 
	...
	call	??0RB_Bot@@QAE@PAVRaven_Game@@UVector2D@@@Z ; RB_Bot::RB_Bot
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z$0:
	mov	eax, DWORD PTR $T142455[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	pop	ecx
	ret	0
__ehhandler$?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-20]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?makeBot@RB_BotMaker@@EBEPAVAbstRaven_Bot@@PAVRaven_Game@@UVector2D@@@Z ENDP ; RB_BotMaker::makeBot
...
; File c:\users\teaja\documents\artificial-fun\labravenprojecttest\raven\bots\rbbot\rb_botmaker.cpp
text$yc	ENDS
;	COMDAT ??__E?registerThis@RB_BotMaker@@0V1@B@@YAXXZ
text$yc	SEGMENT
??__E?registerThis@RB_BotMaker@@0V1@B@@YAXXZ PROC	; `dynamic initializer for 'RB_BotMaker::registerThis'', COMDAT

; 4    : const RB_BotMaker RB_BotMaker::registerThis;

	push	ebp
	mov	ebp, esp
	mov	ecx, OFFSET ?registerThis@RB_BotMaker@@0V1@B ; RB_BotMaker::registerThis
	call	??0RB_BotMaker@@AAE@XZ			; RB_BotMaker::RB_BotMaker
	cmp	ebp, esp
	call	__RTC_CheckEsp
	pop	ebp
	ret	0
??__E?registerThis@RB_BotMaker@@0V1@B@@YAXXZ ENDP	; `dynamic initializer for 'RB_BotMaker::registerThis''
text$yc	ENDS
...
PUBLIC	?registerThis@RB_BotMaker@@0V1@B		; RB_BotMaker::registerThis
...
?registerThis@RB_BotMaker@@0V1@B DD 01H DUP (?)		; RB_BotMaker::registerThis
_BSS	ENDS
...
?registerThis$initializer$@RB_BotMaker@@0P6AXXZA DD FLAT:??__E?registerThis@RB_BotMaker@@0V1@B@@YAXXZ ; RB_BotMaker::registerThis$initializer$
CRT$XCU	ENDS
;	COMDAT CRT$XCU
CRT$XCU	SEGMENT
