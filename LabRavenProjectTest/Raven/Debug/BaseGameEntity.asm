; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Teaja\Documents\Artificial-Fun\LabRavenProjectTest\Common\Game\BaseGameEntity.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_pi	DQ	0400921f9f01b866er		; 3.14159
$SG127690 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
	ORG $+4
$SG127691 DB	'.', 00H, '.', 00H, '\', 00H, 'C', 00H, 'o', 00H, 'm', 00H
	...
	DB	'p', 00H, 00H, 00H
	ORG $+4
$SG127692 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
; File c:\users\teaja\documents\artificial-fun\labravenprojecttest\common\game\basegameentity.cpp
rdata$r	SEGMENT
...
; 26   :   assert ( (val >= m_iNextValidID) && "<BaseGameEntity::SetID>: invalid ID");
	...
	jl	SHORT $LN3@SetID
	mov	ecx, OFFSET $SG127690
	test	ecx, ecx
	jne	SHORT $LN4@SetID
$LN3@SetID:
	push	26					; 0000001aH
	push	OFFSET $SG127691
	push	OFFSET $SG127692
	call	__wassert
