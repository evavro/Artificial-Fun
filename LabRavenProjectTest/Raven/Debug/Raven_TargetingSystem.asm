; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.40219.01 
	...
	TITLE	C:\Users\Teaja\Documents\Artificial-Fun\LabRavenProjectTest\Raven\Bots\RavenBot\Raven_TargetingSystem.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??0Raven_TargetingSystem@@QAE@PAVAbstRaven_Bot@@@Z ; Raven_TargetingSystem::Raven_TargetingSystem
...
; File c:\users\teaja\documents\artificial-fun\labravenprojecttest\raven\bots\ravenbot\raven_targetingsystem.cpp
rdata$r	SEGMENT
...
_this$ = -4						; size = 4
_owner$ = 8						; size = 4
??0Raven_TargetingSystem@@QAE@PAVAbstRaven_Bot@@@Z PROC	; Raven_TargetingSystem::Raven_TargetingSystem
; _this$ = ecx
...
; 11   : {}
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx], OFFSET ??_7Raven_TargetingSystem@@6B@
	...
	pop	ebp
	ret	4
??0Raven_TargetingSystem@@QAE@PAVAbstRaven_Bot@@@Z ENDP	; Raven_TargetingSystem::Raven_TargetingSystem
_TEXT	ENDS
...
; 24   :   std::list<AbstRaven_Bot*> SensedBots;
...
; 26   :   
; 27   :   std::list<AbstRaven_Bot*>::const_iterator curBot = SensedBots.begin();

	lea	edx, DWORD PTR $T136563[ebp]
	push	edx
	lea	ecx, DWORD PTR _SensedBots$[ebp]
...
$LN5@Update:
	...
	mov	BYTE PTR $T136564[ebp], al
	mov	BYTE PTR __$EHRec$[ebp+8], 4
	lea	ecx, DWORD PTR $T136565[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	movzx	edx, BYTE PTR $T136564[ebp]
	test	edx, edx
	je	$LN3@Update
...
; 33   :       double dist = Vec2DDistanceSq((*curBot)->Pos(), m_pOwner->Pos());
	...
	add	esp, 8
	fstp	QWORD PTR _dist$130925[ebp]

; 34   : 
; 35   :       if (dist < ClosestDistSoFar)

	fld	QWORD PTR _ClosestDistSoFar$[ebp]
	fcomp	QWORD PTR _dist$130925[ebp]
	fnstsw	ax
...
; 37   :         ClosestDistSoFar = dist;
	...
	fld	QWORD PTR _dist$130925[ebp]
	fstp	QWORD PTR _ClosestDistSoFar$[ebp]
...
; 782  : 		return (iterator(this->_Nextnode(this->_Myhead), this));
	...
	mov	ecx, DWORD PTR $T136676[ebp]
	or	ecx, 1
	mov	DWORD PTR $T136676[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 792  : 		return (iterator(this->_Myhead, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@1@PBV?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> > >::_List_iterator<std::_List_val<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> > >
	mov	eax, DWORD PTR $T136681[ebp]
	or	eax, 1
	mov	DWORD PTR $T136681[ebp], eax
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 706  : 					_Right._Mysize);
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 5
	lea	ecx, DWORD PTR $T136704[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T136702[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR $T136700[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
...
$T136758 = -84						; size = 4
$T136757 = -80						; size = 4
__Next$132941 = -72					; size = 12
__Iter$132935 = -52					; size = 12
__Next$132931 = -32					; size = 12
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
__Where$ = 8						; size = 12
__Right$ = 20						; size = 4
...
; 1442 : 				for (const_iterator _Next = _First; _Next != _Last; )
	...
	push	ecx
	lea	ecx, DWORD PTR __Next$132931[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	BYTE PTR __$EHRec$[ebp+8], 3
$LN6@Splice:
...
; 1444 : 					const_iterator _Iter = _Next++;
	...
	push	0
	lea	ecx, DWORD PTR __Iter$132935[ebp]
	push	ecx
	lea	ecx, DWORD PTR __Next$132931[ebp]
...
; 1445 : 					_Orphan_ptr(_Right, _Iter._Ptr);
	...
	mov	edx, DWORD PTR __Iter$132935[ebp+8]
	push	edx
	mov	eax, DWORD PTR __Right$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1458 : 			for (const_iterator _Next = _First; _Next != _Last; ++_Next)
	...
	push	eax
	lea	ecx, DWORD PTR __Next$132941[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
...
; 1459 : 				insert(_Where, (_Ty &&)*_Next);
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T136760[ebp], esp
	lea	eax, DWORD PTR __Where$[ebp]
	push	eax
	call	??0?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv284[ebp], eax
	lea	ecx, DWORD PTR $T136761[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1460 : 			_Right.erase(_First, _Last);
	...
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	mov	DWORD PTR $T136763[ebp], esp
	lea	edx, DWORD PTR __First$[ebp]
	push	edx
	call	??0?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	DWORD PTR tv291[ebp], eax
	lea	eax, DWORD PTR $T136764[ebp]
	push	eax
	mov	BYTE PTR __$EHRec$[ebp+8], 2
	mov	ecx, DWORD PTR __Right$[ebp]
	call	?erase@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@0@Z ; std::list<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> >::erase
	mov	DWORD PTR tv288[ebp], eax
	lea	ecx, DWORD PTR $T136764[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN4@Splice:
...
; 1081 : 		{	// erase [_First, _Last)
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T136854[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], 2

; 1082 : 		if (_First == begin() && _Last == end())

	lea	eax, DWORD PTR $T136845[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?begin@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@XZ ; std::list<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> >::begin
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 3
	mov	edx, DWORD PTR $T136854[ebp]
	or	edx, 1
	mov	DWORD PTR $T136854[ebp], edx
	...
	mov	ecx, DWORD PTR $T136854[ebp]
	or	ecx, 2
	mov	DWORD PTR $T136854[ebp], ecx
...
$LN8@erase:
	...
	mov	BYTE PTR $T136844[ebp], cl
	mov	DWORD PTR __$EHRec$[ebp+8], 3
	mov	edx, DWORD PTR $T136854[ebp]
	and	edx, 2
	je	SHORT $LN15@erase
	and	DWORD PTR $T136854[ebp], -3		; fffffffdH
	lea	ecx, DWORD PTR $T136846[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN15@erase:
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	eax, DWORD PTR $T136854[ebp]
	and	eax, 1
	je	SHORT $LN16@erase
	and	DWORD PTR $T136854[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T136845[ebp]
	call	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN16@erase:
	movzx	ecx, BYTE PTR $T136844[ebp]
	test	ecx, ecx
	je	SHORT $LN2@erase
...
__unwindfunclet$?erase@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@0@Z$4:
	...
	and	eax, 4
	je	$LN18@erase
	and	DWORD PTR $T136854[ebp], -5		; fffffffbH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN18@erase:
	ret	0
...
; 245  : 		return (_Tmp);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@ABV01@@Z
	mov	edx, DWORD PTR $T136907[ebp]
	or	edx, 1
	mov	DWORD PTR $T136907[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Tmp$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??E?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE?AV01@H@Z$1:
	mov	eax, DWORD PTR $T136907[ebp]
	and	eax, 1
	je	$LN5@operator@5
	and	DWORD PTR $T136907[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN5@operator@5:
	ret	0
...
; 802  : 		return (iterator(_Where._Ptr, this));
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@PAU_Node@?$_List_nod@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@1@PBV?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@1@@Z ; std::_List_iterator<std::_List_val<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> > >::_List_iterator<std::_List_val<AbstRaven_Bot *,std::allocator<AbstRaven_Bot *> > >
	mov	edx, DWORD PTR $T136942[ebp]
	or	edx, 1
	mov	DWORD PTR $T136942[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$?_Make_iter@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QBE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@@Z$1:
	mov	eax, DWORD PTR $T136942[ebp]
	and	eax, 1
	je	$LN5@Make_iter
	and	DWORD PTR $T136942[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN5@Make_iter:
	ret	0
...
__unwindfunclet$?erase@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@2@@Z$3:
	mov	eax, DWORD PTR $T136958[ebp]
	and	eax, 1
	je	$LN10@erase@2
	and	DWORD PTR $T136958[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN10@erase@2:
	ret	0
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T137025[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T137025[ebp], 0
	...
	mov	ecx, DWORD PTR $T137025[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T137025[ebp]
...
; 742  : 		return (_Make_iter(--_Where));
	...
	mov	ecx, DWORD PTR $T137053[ebp]
	or	ecx, 1
	mov	DWORD PTR $T137053[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __Where$[ebp]
	call	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
__unwindfunclet$??$emplace@PAVAbstRaven_Bot@@@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@$$QAPAVAbstRaven_Bot@@@Z$0:
	...
	jmp	??1?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
__unwindfunclet$??$emplace@PAVAbstRaven_Bot@@@?$list@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@QAE?AV?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@V?$_List_const_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@1@$$QAPAVAbstRaven_Bot@@@Z$3:
	mov	eax, DWORD PTR $T137053[ebp]
	and	eax, 1
	je	$LN7@emplace
	and	DWORD PTR $T137053[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	jmp	??1?$_List_iterator@V?$_List_val@PAVAbstRaven_Bot@@V?$allocator@PAVAbstRaven_Bot@@@std@@@std@@@std@@QAE@XZ
$LN7@emplace:
	ret	0
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T137100[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T137100[ebp], 0
	je	SHORT $LN3@construct@2
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
	call	??$forward@PAVAbstRaven_Bot@@@std@@YA$$QAPAVAbstRaven_Bot@@AAPAV1@@Z ; std::forward<AbstRaven_Bot *>
	add	esp, 4
	mov	edx, DWORD PTR $T137100[ebp]
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR [edx], eax
	mov	ecx, DWORD PTR $T137100[ebp]
