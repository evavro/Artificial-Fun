...
bool Goal_MoveToPosition::HandleMessage(const Telegram& msg)
{
  ...
  LARGE_INTEGER pathPlanningTime;
  ...
  if (bHandled == false)
  {
    ...
    case Msg_PathReady:
      ...
      AddSubgoal(new Goal_FollowPath(m_pOwner,
		...
		pathPlanningTime = m_pOwner->GetPathPlanner()->GetTime();

		#ifdef SHOW_NAVINFO
		  debug_con << "Path found. Planning time: " << ttos(pathPlanningTime.QuadPart) << "";
		#endif

	  m_pOwner->AddTime(pathPlanningTime);
