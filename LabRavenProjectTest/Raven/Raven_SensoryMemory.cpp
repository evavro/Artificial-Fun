...
//------------------------------- ctor ----------------------------------------
//-----------------------------------------------------------------------------
 Raven_SensoryMemory:: Raven_SensoryMemory(AbstRaven_Bot* owner,
...
void Raven_SensoryMemory::MakeNewRecordIfNotAlreadyPresent(AbstRaven_Bot* pOpponent)
{
...
//-----------------------------------------------------------------------------
void Raven_SensoryMemory::RemoveBotFromMemory(AbstRaven_Bot* pBot)
{
...
//-----------------------------------------------------------------------------
void Raven_SensoryMemory::UpdateWithSoundSource(AbstRaven_Bot* pNoiseMaker)
{
...
// UpdateVision method is called
//-----------------------------------------------------------------------------
void Raven_SensoryMemory::UpdateWithDamageSource(AbstRaven_Bot* pShooter, int damage)
{
  //make sure the bot being examined is not this bot
...
//  obscured by walls)
//-----------------------------------------------------------------------------
bool Raven_SensoryMemory::isOpponentShootable(AbstRaven_Bot* pOpponent)const
{
...
//-----------------------------------------------------------------------------
bool  Raven_SensoryMemory::isOpponentWithinFOV(AbstRaven_Bot* pOpponent)const
{
  MemoryMap::const_iterator it = m_MemoryMap.find(pOpponent);
...
//-----------------------------------------------------------------------------
Vector2D  Raven_SensoryMemory::GetLastRecordedPositionOfOpponent(AbstRaven_Bot* pOpponent)const
{
  MemoryMap::const_iterator it = m_MemoryMap.find(pOpponent);
...
//-----------------------------------------------------------------------------
double  Raven_SensoryMemory::GetTimeOpponentHasBeenVisible(AbstRaven_Bot* pOpponent)const
{
  MemoryMap::const_iterator it = m_MemoryMap.find(pOpponent);
...
int  Raven_SensoryMemory::GetDamage(AbstRaven_Bot* pOpponent)const
{
  MemoryMap::const_iterator it = m_MemoryMap.find(pOpponent);
...
//-----------------------------------------------------------------------------
double Raven_SensoryMemory::GetTimeOpponentHasBeenOutOfView(AbstRaven_Bot* pOpponent)const
{
  MemoryMap::const_iterator it = m_MemoryMap.find(pOpponent);
...
//  returns the amount of time the given bot has been visible
//-----------------------------------------------------------------------------
double  Raven_SensoryMemory::GetTimeSinceLastSensed(AbstRaven_Bot* pOpponent)const
{
  MemoryMap::const_iterator it = m_MemoryMap.find(pOpponent);
...
bool	Raven_SensoryMemory::isUnderAttack ( ) const
{
  MemoryMap::const_iterator curRecord = m_MemoryMap.begin();
  for (curRecord; curRecord!=m_MemoryMap.end(); ++curRecord)
  {
